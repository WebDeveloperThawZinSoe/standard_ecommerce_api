...
<body>
    ...
    <div class="main container" style="min-height: 600px;">
        ...
        <div class="help-center">
            ...
            @endphp
            <img src="{{ asset('images/general_settings/' . $contact_image) }}">
                        @php
            $generalSettings =  App\Models\GeneralSetting::whereIn('name', [
                    'about_us', 'contact_us' , 'how_to_sell_us', 'phone_number_1', 'phone_number_2', 'phone_number_3',
                    'email_1', 'email_2', 'email_3', 'facebook', 'telegram', 'discord' , 'viber' , 'skype'
                ])->pluck('value', 'name');

            @endphp

            @if($generalSettings->get('contact_us'))
            <div class="site-info">
                <div class="container" style="position: relative;">
                <h2>Contact Us</h2>
                    <section>
                        <p>{!! $generalSettings['contact_us'] !!}</p>
                    </section>
                </div>
            </div>
            @endif
